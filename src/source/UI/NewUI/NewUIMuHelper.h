...
private:
    ...
    void InsertButton(int imgindex, int x, int y, int sx, int sy, bool overflg, bool isimgwidth, bool bClickEffect,
                      bool MoveTxt, const wchar_t* const* btnameSlot, const wchar_t* const* tooltipSlot, int Identifier,
                      int iNumTab);
    //--
    void RenderBoxList();
    ...
    void InsertCheckBox(int imgindex, int x, int y, int sx, int sy, bool overflg, const wchar_t* const* btnameSlot,
...
private:
    ...
    CUITextInputBox m_AttackDelayInput;
